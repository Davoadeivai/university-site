...
FACULTIES = [
    ...
    (
        ...
        'حسابداری، مدیریت بازرگانی و مدیریت صنعتی و مالی — از کاردانی '
        'تا کارشناسی ارشد.',
    ...
    (
        ...
        ['روانشناسی', 'علومتربیتی', 'علومپایه', 'علوماجتماعی'],
    ),
]

# ردیف‌هایی که دانشکده نیستند و باید برداشته شوند.
#
# «دانشکده عمومی» روی سرور همهٔ یازده گروه را زیر خودش نگه داشته
# بود و سه دانشکدهٔ واقعی صفر گروه نشان می‌دادند. چون در این فهرست
# نبود، دستور آن را یک انتخاب عمدی مدیر می‌دید و دست نمی‌زد —
# دقیقاً همان محافظی که برای احترام به تصمیم مدیر گذاشته شده بود،
# اینجا جلوی اصلاح را می‌گرفت.
PLACEHOLDERS = ['bargh', 'تحصیلات تکمیلی', 'دانشکده عمومی', 'عمومی']
