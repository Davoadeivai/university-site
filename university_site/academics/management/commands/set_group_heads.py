...
یک گروه ممکن است دو مدیر داشته باشد — موسسه برای حسابداری و مدیریت
صنعتی دو نفر نوشته — و هر دو نام کنار هم می‌آیند. مدیری که گروهش
روی سایت نیست (مثل «مدیر گروه مدیریت» که میان سه گروه پخش است)
بی‌صدا کنار گذاشته نمی‌شود؛ در گزارش پایان کار نامش می‌آید.
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            for group in groups:
                ...
                text = ' و '.join(names)
                professor = self._professor_for(names[0]) \
