...
/* ── زیرمنوی تودرتوی معاونت‌ها ───────────────────────────────────
   حالا روی هر دستگاه یک رفتار: زیرشاخه در جای خودش باز می‌شود، با
   همین دکمه. پیش از این روی دسکتاپ پنجره‌ای کنارِ منو با هاور باز
   می‌شد و همین یک رفتارِ دوم بود که زیر دست می‌پرید.
