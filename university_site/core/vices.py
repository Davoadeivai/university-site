...
STATIC_UNITS = {
    # زیرمجموعه‌ها از چارت سازمانی موسسه برداشته شده‌اند.
    #
    # آن‌هایی که صفحهٔ خودشان را دارند، نامِ مسیرشان کنارشان است؛
    # بقیه رشتهٔ خالی می‌گیرند و در منو به‌صورت متن ساده می‌آیند —
