...
UNITS = [
    ...
    {
        # هیئت موسس هم مثل هیئت امنا دبیرخانهٔ خودش را دارد؛ تا امروز
        # روی سایت نبود. هر دو زیر «ارکان موسسه» می‌آیند، نه زیر ریاست.
        'slug': 'dabirkhane-heyat-moases',
        'title': 'دبیرخانه هیأت مؤسس',
        'icon': 'fa-building-columns',
        'manager_title': 'دبیر هیئت مؤسس',
        'location': 'ساختمان مرکزی، طبقهٔ دوم',
        'office_hours': 'شنبه تا چهارشنبه، ۸ تا ۱۵',
        'content': (
            'هیئت مؤسس، بنیان‌گذار موسسه است و اساسنامه و خط‌مشی بلندمدت '
            'از آن می‌آید. این دبیرخانه جلسات هیئت مؤسس را تدارک می‌بیند و '
            'مصوباتش را به ارکان دیگر موسسه می‌رساند.'
        ),
        'duties': (
            'تدارک جلسات هیئت مؤسس و تنظیم دستور کار\n'
            'ابلاغ و پیگیری مصوبات هیئت مؤسس\n'
            'نگهداری اساسنامه، اسناد تأسیس و سوابق جلسات\n'
            'هماهنگی میان هیئت مؤسس و هیئت امنا'
        ),
    },
    {
