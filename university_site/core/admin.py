...
class SiteSettingsAdmin(CompletenessAdminMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('نوار خبر فوری', {
            ...
            'description': (
                'نوار قرمزِ زیر بنر. عدد اول یعنی یک اطلاعیه چند ثانیه '
                'طول بکشد تا از لبهٔ چپ صفحه به لبهٔ راست برسد: '
                '<b>هر چه بزرگ‌تر، آهسته‌تر</b>. ۴۵ تا ۶۰ خوانا است؛ '
                'با ۱ خبر مثل برق رد می‌شود. «مکث» یعنی نوار چند ثانیه '
                'خالی بماند و بعد خبر وارد شود؛ صفر یعنی بی‌وقفه.<br>'
